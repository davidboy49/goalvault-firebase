      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        <Card className="w-full max-w-md">
          ...
          <CardContent className="space-y-3">
            ...
            />
            <Button className="w-full" onClick={handleEmailLogin} disabled={submitting || loading}>
              Email Sign In
            </Button>
            <Button className="w-full" variant="outline" onClick={handleGoogleLogin} disabled={submitting || loading}>
